            ...
            <main className='newjsx-formbox'>
                ...
                <form method='POST' action='/places'>
                    ...
                    <div className="form-group">
                        ...
                        <input type='number' className="form-control" value={new Date().getFullYear()} id="founded" name="founded" />
                    </div>
                    <input class='btn btn-primary' type='submit' value='Add Place'></input>
                </form>
            </main>
        </Def>
    )
